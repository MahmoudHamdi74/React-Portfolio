...
const Hero = () => {
  ...
  return (
    ...
    <div className='relative flex flex-col lg:flex-row items-center justify-center min-h-screen lg:h-screen lg:max-h-[calc(110vh-4.5rem)] overflow-hidden px-4 md:px-8 pt-8 pb-16 lg:pt-0'>
      ...
      <div className='block lg:hidden scale-75 h-64 mb-10'>
        <TechCloud />
      </div>
      <div className='container relative mx-auto lg:ml-44 text-center lg:text-left h-full flex flex-col justify-center items-center lg:items-start '>
      ...
      <div className='mt-10 lg:mr-40 hidden lg:block'>
        <TechCloud />
      </div>
    </div>
      </section>
