  ...
  return (
    <section key={activeTab} className="py-16 md:py-20 px-4 md:px-8 " id="contact">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-center mb-12 text-gray-600 dark:text-gray-400 mt-4 max-w-2xl mx-auto">
          {content.description}
        </p>
          ...
          <div className="flex rounded-lg p-1 bg-amber-50 border border-amber-200 dark:bg-gray-900/60 dark:border-purple-800/50">
            {[
              ...
              <button
                ...
                className={`relative px-6 py-3 m-1 rounded-lg font-medium text-md transition-all duration-300 hover:scale-102 active:scale-98 ${activeTab === tab.id ? "bg-amber-300 shadow-sm shadow-amber-200 dark:bg-purple-600 dark:shadow-purple-900/30 text-gray-900 dark:text-white" : "text-gray-600 hover:bg-amber-100 dark:text-gray-400 dark:hover:bg-purple-900/30"}`}
              >
                ...
                <div className="rounded-2xl p-8 shadow-md border bg-amber-50/80 border-amber-200 shadow-amber-100 dark:bg-gray-900/50 dark:border-purple-800/50 dark:shadow-purple-900/30">
                  ...
                  <div className="flex flex-col sm:flex-row gap-8 pt-8">
                    ...
                    <button
                      ...
                      className="flex-1 text-center py-3 px-6 rounded-lg font-medium border transition-colors hover:scale-102 active:scale-98 border-amber-300 hover:bg-amber-100 text-gray-700 dark:border-purple-700 dark:hover:bg-purple-900/30 dark:text-purple-300"
                    >
